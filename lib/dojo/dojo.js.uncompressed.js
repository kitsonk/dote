...
define(["./sniff", "./dom"], function(has, dom){
	...
	var _getOpacity =
		has("ie") < 9 || (has("ie") &&  0 ) ? function(node){
			try{
	...
	var _setOpacity =
		has("ie") < 9 || (has("ie") &&  0 ) ? function(/*DomNode*/ node, /*Number*/ opacity){
	...
	var window = {
		...
		scrollIntoView: function(/*DomNode*/ node, /*Object?*/ pos){
			...
			try{ // catch unexpected/unrecreatable errors (#7808) since we can recover using a semi-acceptable native method
				...
				if((!(has("mozilla") || isIE || isWK ||  0 ) || node == body || node == html) && (typeof node.scrollIntoView != "undefined")){
