...
], function(_StoreMixin, _TopicMixin, array, declare, lang, win, domClass, domGeom, JSON, on, winUtil, _Contained,
...
define("dote-client/viewTopicList", [
	...
	ready(function(){
		...
		tl.startup();
		tl.fetch().then(function(){
			0 && console.log("fetch done");
		});
	});
